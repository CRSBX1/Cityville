...
int printMenu(const string& title, const string options[], int optionCount, int separatorWidth, char separatorChar, const string& prompt);
...
int selectCityExtended(bool showBack = true, int defaultChoice = 1);
